...
import type { VideoSourceChapter, VideoStoryGenre, VideoStoryTone } from "@/types/video-project";
...
export default function CreateVideoProjectPage() {
  ...
  const [sourceMode, setSourceMode] = useState<"text" | "chapter">("text");
  ...
  function handleSourceModeChange(mode: "text" | "chapter") {
    setSourceMode(mode);
  ...
  return (
    <section className="space-y-4">
      <div className="rounded-lg bg-white p-4 shadow-sm">
        ...
        <p className="mt-1 text-sm text-zinc-500">选择粘贴文本或已有章节作为内容来源，再进入分镜制作。</p>
      </div>
      ...
      <section className="rounded-lg bg-white p-4 shadow-sm">
        ...
        <div className="mt-3 grid grid-cols-2 gap-1 rounded-md bg-zinc-100 p-1">
          <button
